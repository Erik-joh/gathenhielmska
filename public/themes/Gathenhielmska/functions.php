...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_register_script('jquery', 'https://code.jquery.com/jquery-1.12.4.min.js', '', '', true);
    ...
    wp_enqueue_style('fonts', '//fonts.googleapis.com/css2?family=Lato:wght@400;700&display=swap');
});
